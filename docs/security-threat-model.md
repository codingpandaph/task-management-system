...
| Tasks and reports    | Cross-department access              | Workspace, board collaborator and director scope checks on every API path                                                | Multi-role API and Playwright journeys          |
